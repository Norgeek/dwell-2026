...
const DAYS = [
  ...
  },
  {
    ...
    audioUrl: "/audio/day-38.mp3",
    quotes: [
      { text: "The highest calling of the Christian life is not merely to work for God, but to walk with Him.", author: "Brother Lawrence" },
      { text: "It is possible to serve God without loving Him, but it is impossible to love Him without serving Him.", author: "Hudson Taylor" },
    ],
    anchor: [
      { text: "You are My friends if you do whatever I command you. No longer do I call you servants, for a servant does not know what his master is doing; but I have called you friends, for all things that I heard from My Father I have made known to you.", ref: "John 15:14-15 (NKJV)" },
    ],
    scriptures: ["John 15:9-17", "Matthew 7:21-23", "Genesis 18:16-33", "Psalm 51:1-17"],
    body: [
      { t: "p", x: "There are moments in Scripture where Jesus says something so personal that it reshapes the entire way we understand our relationship with God. John 15 is one of those moments." },
      { t: "p", x: "On the night before the cross, Jesus speaks to His disciples about abiding, fruitfulness, obedience, and love. Then, in the middle of that conversation, He says something astonishing: 'I have called you friends.' This is more than comforting language. It is an invitation into the heart of God." },
      ...
      { t: "p", x: "This becomes even clearer when contrasted with the word Jesus uses for servants, the Greek doulos. A doulos was a servant or bondservant, someone under the authority of a master. Scripture often uses this word positively. Paul repeatedly called himself a servant of Christ. So Jesus is not rejecting servanthood. Rather, He is revealing that life with Him was never meant to remain at the level of task execution alone." },
      { t: "p", x: "Servants carry instructions. Friends are brought into counsel." },
      { t: "p", x: "Jesus says, 'A servant does not know what his master is doing.' The issue is not activity, but intimacy. Servants may obey commands without understanding the larger purpose. Friends are entrusted with revelation and understanding." },
      { t: "p", x: "This is why Jesus continues by saying that He has made known to His disciples everything He heard from the Father. The phrase made known comes from the Greek gnorizo, meaning to reveal, disclose, or cause someone to understand. Friendship with God involves shared revelation. Jesus does not merely assign work. He reveals the Father's heart behind the work." },
      { t: "d" },
      { t: "p", x: "This pattern appears throughout Scripture. 'He made known His ways to Moses, His acts to the children of Israel' (Psalm 103:7). Israel witnessed God's miracles and deliverance, but Moses was brought into deeper understanding and communion. Friendship with God moves beyond seeing what He does into knowing His heart and ways." },
      { t: "p", x: "Abraham was called the friend of God because he trusted God deeply enough to follow Him beyond what was visible. God even brought Abraham into His counsel before the judgment of Sodom, asking, 'Shall I hide from Abraham what I am doing?' Friendship with God involves partnership with His purposes. Abraham was not merely informed. He was invited into intercession because friendship causes us to care about what God cares about." },
      { t: "p", x: "Enoch gives us another picture of friendship with God (Genesis 5:21-24). Scripture says he 'walked with God,' language that points to continual companionship and steady fellowship. His life shows us that friendship with God is not built merely on dramatic moments or public assignments, but on consistent communion over time." },
      { t: "p", x: "David reveals another dimension of friendship with God: responsiveness. He loved God's Word, delighted in worship, and carried unusual revelation concerning God's kingdom and the coming Messiah. Yet one of the clearest evidences of his intimacy with God appeared after failure." },
      { t: "p", x: "When confronted over his sin with Bathsheba, David did not protect his image or justify himself. Instead he cried:" },
      { t: "s", x: "'Create in me a clean heart, O God... Do not cast me away from Your presence...'", r: "Psalm 51:10-11" },
      { t: "p", x: "David's deepest fear was not losing a throne, but losing intimacy with God's presence. Friends of God value restored fellowship more than self-preservation. When they fail, they return quickly in repentance because communion matters more to them than appearance." },
      { t: "d" },
      { t: "p", x: "This gives deeper weight to Jesus' warning in Matthew 7:" },
      { t: "s", x: "'And then I will declare to them, \"I never knew you; depart from Me, you who practice lawlessness!\"'", r: "Matthew 7:23 (NKJV)" },
      { t: "p", x: "What makes this sobering is that these people had visible works. They prophesied, cast out demons, and performed mighty acts. Yet Jesus points to a deeper issue: relational distance. The word knew here speaks of experiential and personal relationship. This reveals an important truth. Ministry activity is not the same as intimacy with Christ. A person may appear spiritually productive while remaining relationally distant from God." },
      { t: "p", x: "Friendship with God cannot be replaced by gifting, visibility, or outward success." },
      { t: "p", x: "This is why Jesus connects friendship with obedience: 'You are My friends if you do whatever I command you.' Obedience is not an attempt to earn friendship. It is the expression of trust within friendship. Friends of God take His words seriously because they love Him and trust His heart. Intimacy does not produce independence from God. It produces deeper surrender to Him." },
      { t: "d" },
      { t: "p", x: "Daniel's life reflects this beautifully. Though not explicitly called a friend of God, he lived like one. He was called 'greatly beloved,' received insight into mysteries and kingdoms, and carried wisdom that influenced rulers and nations. His intimacy with God produced discernment, courage, and clarity in difficult environments." },
      { t: "p", x: "Job also gives us a remarkable picture of the fruit of friendship with God. He spoke of a season when the 'friendly counsel' of God rested over his household. Yet that intimacy did not isolate him from society. It made him a source of justice, wisdom, compassion, and protection for others. Friendship with God overflowed into practical impact." },
      { t: "p", x: "And this brings the entire journey of dwelling together." },
      { t: "p", x: "We have learned to come near to God, abide in Christ, and engage His Word. We have seen that His Word sanctifies, heals, restores, guides, transforms, and makes fruitful. We have discovered gifts, calling, and divine appointment. But beneath all these things is the deeper desire of God Himself." },
      { t: "p", x: "God is not merely forming productive servants. He is drawing beloved friends into fellowship with Him." },
      { t: "d" },
      ...
      { t: "p", x: "The same invitation stands before us today. As we continue to dwell in God's presence and remain in His living Word, we are drawn into deeper intimacy with Him. His Word shapes our hearts, His Spirit reveals His ways, and His life begins to flow through ours." },
      { t: "p", x: "Over time, we become people who not only work for God, but walk with Him. People who know His heart. People who carry His love into the world. And through lives rooted in friendship with God, the Father's glory is revealed." },
      { t: "d" },
      { t: "p", x: "Father, thank You for drawing me near through Christ and inviting me into friendship with You. Teach me to walk closely with You, love Your Word, obey Your voice, and remain sensitive to Your Spirit. Let my life reflect Your heart, Your love, and Your glory to the world. Amen." },
    ],
    journal: [
      "In what ways is God inviting you into deeper trust, obedience, and fellowship with Him?",
      "Are there areas where your relationship with God has become more about activity than intimacy?",
      "How do you usually respond when God corrects or convicts you?",
      "What practices help you remain aware of God's presence and close to His heart?",
    ],
    prayers: [
      "Thank God for inviting you into friendship and fellowship through Christ.",
      "Ask for a deeper hunger for intimacy with God beyond outward activity or performance.",
      "Pray for a responsive heart that quickly returns to God in repentance and humility.",
      "Ask the Holy Spirit to help you know God's ways and discern His heart more clearly.",
      "Pray that your life will reflect God's love, wisdom, and presence to those around you.",
    ],
    declaration: "I am a friend of God, invited to walk closely with Him in love, trust, and fellowship. As I abide in His Word, He reveals His heart and shapes my life according to His purposes. I am learning to know His ways, not just witness His works. I choose intimacy over performance and obedience over self-will. When I fail, I return quickly to God, valuing His presence above all else. As I walk with Him daily, His love, wisdom, and character are revealed through my life. Amen.",
  },
  {
    day: 39,
    title: "Dwelling in the Land",
    audioUrl: "/audio/day-39.mp3",
    quotes: [
      { text: "The safest place on earth is in the will of God.", author: "Corrie ten Boom" },
      { text: "God never intended His people to hide from the world, but to influence it.", author: "Myles Munroe" },
    ],
    anchor: [
      { text: "Sojourn in this land, and I will be with you and will bless you...", ref: "Genesis 26:3 (ESV)" },
      { text: "Trust in the Lord, and do good; dwell in the land, and feed on His faithfulness.", ref: "Psalm 37:3 (NKJV)" },
    ],
    scriptures: ["Genesis 26:1-22", "Psalm 37:3-7", "Jeremiah 29:4-7", "Luke 19:12-27"],
    body: [
      { t: "p", x: "Having seen that Jesus calls us friends and appoints us to bear lasting fruit, we now come to a vital question: where exactly are we to bear that fruit? The answer is not vague. We are called to bear fruit in the place of our appointment, the place where God sends, plants, assigns, or positions us." },
      { t: "p", x: "The fruit and gifts God cultivates in us are not meant to float without context. They are meant to be expressed in real places, seasons, communities, industries, families, cities, and assignments. Once we find ourselves where God wants us, we must learn to dwell there." },
      { t: "p", x: "Dwelling, in this context, means more than occupying a location. It means becoming faithful, rooted, responsible, and fruitful where God has placed us. It means embracing our appointed place, seeking its welfare, serving with diligence, and remaining faithful even when outward conditions seem unfavorable." },
      { t: "p", x: "Genesis 26 gives us a powerful picture. There was famine in the land, and Isaac could easily have gone down to Egypt, following a familiar pattern of escape in crisis. But God said, 'Do not go down to Egypt; live in the land of which I shall tell you.' Then He added, 'Sojourn in this land, and I will be with you and will bless you.'" },
      { t: "p", x: "The word translated 'sojourn' is the Hebrew gur, meaning to dwell temporarily, reside as a stranger, or remain in a place without treating it as one's final homeland. This gives us a picture of the believer's life. We are called to be present and faithful where God assigns us, while remembering that our ultimate citizenship is in heaven. We build, plant, serve, and occupy, but we do not allow the present world to possess our hearts." },
      { t: "p", x: "Psalm 37 adds another dimension: 'Trust in the Lord, and do good; dwell in the land, and feed on His faithfulness.' The word translated 'dwell' is connected to the Hebrew shakan, meaning to settle, reside, remain, or inhabit. It carries the idea of settled presence. Dwelling is not passive waiting. It is a trust-filled, goodness-producing way of living." },
      { t: "p", x: "Psalm 37 gives us a rhythm: trust in the Lord, do good, dwell in the land, and feed on His faithfulness. To dwell rightly, we must be careful what we feed on. If we feed on fear, comparison, or visible instability, we will be tempted to flee. But if we feed on God's faithfulness, we gain strength to remain and obey." },
      { t: "p", x: "Isaac's obedience is striking because God told him to remain during famine. The land did not look promising. The season did not appear favorable. Yet Isaac did not merely stay. He sowed." },
      { t: "p", x: "'Then Isaac sowed in that land, and reaped in the same year a hundredfold; and the Lord blessed him' (Genesis 26:12)." },
      { t: "p", x: "This is one of the clearest lessons of the passage. Dwelling in the land does not mean going into hibernation. It means remaining actively faithful. It means stewarding what is in your hand, sowing in obedience, and trusting God to bless the place He assigned, even when the season looks dry." },
      { t: "p", x: "Isaac prospered not because the land looked fertile, but because the Lord was with him there." },
      { t: "d" },
      { t: "p", x: "This challenges many assumptions. There are times when the wisdom of God contradicts the obvious escape route. Yesterday's strategy may not be today's instruction. What worked in a previous season may not be what God is saying now. Isaac had to hear God for his own famine." },
      { t: "p", x: "This introduces divine innovation. God's instruction was not to run to the visible place of supply, but to remain in the place of promise. When others withdraw, God may tell us to sow. When others repeat old templates, God may give fresh wisdom. The place of appointment often yields its best when we stop copying and start listening." },
      { t: "p", x: "To dwell in the land is also to take responsibility. God does not place His people merely to survive. He places them to represent His kingdom. Isaac had to sow. Joseph had to manage. Daniel had to govern. Jeremiah told the exiles in Babylon to build, plant, multiply, and seek the welfare of the city." },
      { t: "p", x: "This means we do not merely complain about the condition of the land. We ask, 'Lord, what have You placed in me that is meant to bless this place?'" },
      { t: "p", x: "Jeremiah's instruction to the exiles is especially powerful: 'Seek the welfare of the city where I have sent you into exile, and pray to the Lord on its behalf' (Jeremiah 29:7). These were people living in a place they did not choose, under conditions they did not desire. Yet God called them to pray, build, plant, and contribute to the welfare of that place." },
      { t: "p", x: "For the believer, dwelling in the land is not self-centered. We are not placed somewhere merely to extract benefits. We are there to serve, bless, build, and represent God. Often, as we seek the welfare of the place God assigns us, we discover that our own welfare is tied to the good we bring there." },
      { t: "d" },
      { t: "p", x: "Daniel shows us what this looks like in a foreign land. He lived in Babylon, under pagan rulers, in a culture that did not share his covenant values. Yet he did not go into spiritual hibernation. He remained faithful, prayerful, excellent, and engaged. He refused defilement, but he did not refuse responsibility. He interpreted dreams, solved problems, advised kings, and modeled kingdom wisdom in a difficult environment." },
      { t: "p", x: "Daniel teaches us how to dwell as pilgrims without becoming passive or compromised. We are citizens of heaven, yet assigned to earthly arenas. We must remain distinct without becoming detached. We must engage without being absorbed." },
      { t: "p", x: "Jesus gives the New Testament expression of this same principle in the parable of the minas: 'Do business till I come' (Luke 19:13). The word behind this carries the idea of engaging, trading, putting resources to work, and producing results through stewardship. The servants were not told to hide until the master returned. They were told to occupy faithfully." },
      { t: "p", x: "To occupy until He comes means we remain active, watchful, fruitful, and accountable. We steward what has been given. We multiply opportunities. We serve our generation while remembering that the King will return." },
      { t: "p", x: "The land may look dry, but if God has assigned it, He can cause it to yield." },
      { t: "p", x: "Even then, dwelling does not mean there will be no resistance. Isaac's increase provoked envy and conflict over wells. Yet he continued moving, digging, and trusting God until he came to Rehoboth, saying, 'For now the Lord has made room for us, and we shall be fruitful in the land' (Genesis 26:22). Dwelling often includes overcoming contention, reopening wells, and persevering until God makes room." },
      { t: "d" },
      ...
      { t: "p", x: "To dwell in the land is to faithfully embrace the place God assigns, sow despite contrary conditions, seek its welfare, and steward what He has given until He comes. Where God leads, His presence goes with us, His blessing sustains us, and the land can yield its best for His glory." },
      { t: "d" },
      { t: "p", x: "Father, thank You for every place and assignment You entrust to me. Teach me to dwell faithfully, sow obediently, and seek the welfare of where You have placed me. Help me to hear Your voice, remain fruitful, and trust You until You move me or make room for me. Amen." },
    ],
    journal: [
      "Where has God assigned you in this season, and how are you responding?",
      "Are fear, frustration, comfort, or uncertainty influencing whether you stay or move?",
      "What does faithful sowing look like in your current land?",
      "How can you seek the welfare of the place or people God has entrusted to you?",
    ],
    prayers: [
      "Thank God for the places, seasons, and assignments He has entrusted to you.",
      "Receive grace to dwell faithfully where He has planted or positioned you.",
      "Ask for wisdom to sow in obedience, even in unfavorable conditions.",
      "Pray for a heart that seeks the welfare of your assigned place and people.",
      "Ask God to make room for you and cause your appointed land to bear fruit for His glory.",
    ],
    declaration: "I dwell faithfully in the place God has assigned to me, trusting His wisdom and remaining rooted in obedience. I will not be ruled by fear or outward conditions, but I will sow, serve, and remain fruitful where He has planted me. God has placed me in this season to reflect His kingdom and bring blessing to others. As I seek the welfare of where He has sent me, His presence, wisdom, and favor go with me. The land He has appointed for me will yield its best for His glory. Amen.",
  },
  {
    day: 40,
    title: "Manifesting God's Love",
    audioUrl: "/audio/day-40.mp3",
    quotes: [
      { text: "What the world needs today is not more religion, but more love and compassion demonstrated through believers.", author: "Mother Teresa" },
      { text: "Love is the overflow of joy in God that gladly meets the needs of others.", author: "John Piper" },
    ],
    anchor: [
      { text: "By this all will know that you are My disciples, if you have love for one another.", ref: "John 13:35 (NKJV)" },
      { text: "As the Father loved Me, I also have loved you; abide in My love.", ref: "John 15:9 (NKJV)" },
    ],
    scriptures: ["John 15:9-17", "Galatians 5:22-23", "1 John 4:7-21", "1 Corinthians 13:1-13"],
    body: [
      { t: "p", x: "We have arrived at the final day of this journey, and there is no better place to end than in the love of God." },
      { t: "p", x: "After all we have explored, abiding, the Word, sanctification, healing, guidance, transformation, fruitfulness, gifts, appointment, friendship, and dwelling faithfully in the land, everything gathers here. Love is the highest expression of God's nature and the clearest evidence of a life that truly dwells in Him." },
      { t: "p", x: "Love is where dwelling began, and love is where dwelling must lead." },
      { t: "p", x: "From the beginning, God's desire has been relationship. He created humanity in His image, crowned us with dignity, and placed us in fellowship and purpose. Even after sin fractured that communion, He moved toward us with covenant mercy, covering, delivering, restoring, and ultimately giving His Son, who revealed, embodied, and demonstrated His love." },
      { t: "p", x: "The word translated 'love' in John 13:35 and John 15:9 is the Greek agape. It speaks of self-giving love, covenant love, sacrificial love, and love that seeks the highest good of another. Its related verb, agapao, means to love deeply, value highly, and act in loyal devotion." },
      { t: "p", x: "This love is not weak sentiment. It is strong, holy, costly, and redemptive. It does not merely feel. It acts. It gives. It serves. It forgives. It restores. It tells the truth. It lays down its life." },
      { t: "p", x: "John writes, 'We love Him because He first loved us' (1 John 4:19). The first movement of love is not expression, but reception. Before we chose Him, He loved us. Before we served Him, He valued us. Before we bore fruit, He set His love upon us. This matters because many believers try to give love they have not fully received. But divine love cannot be produced by striving. It must first be welcomed, believed, and allowed to settle deeply in the heart." },
      { t: "p", x: "Paul says, 'God demonstrates His own love toward us, in that while we were still sinners, Christ died for us' (Romans 5:8). The cross is the clearest declaration that God's love does not wait for human perfection before it moves. It moves toward the undeserving, the broken, the wandering, and the weak. It cleanses, restores, and brings us near." },
      { t: "p", x: "And this love is not only declared over us; it is poured into us." },
      { t: "p", x: "'The love of God has been poured out in our hearts by the Holy Spirit who was given to us' (Romans 5:5). The Spirit does not merely inform us that God loves us. He opens the heart to experience that love as living truth. He assures us that we are dearly loved, chosen, accepted, and secure in Christ." },
      { t: "d" },
      { t: "p", x: "This is why the Word has been central to our journey. The Word reveals the love of God, and the Spirit makes that revelation alive within us. Through Scripture, we see the heart of the Father, the sacrifice of the Son, and the patient work of the Spirit. The Word also exposes the fears, wounds, lies, and barriers that keep us from receiving love, then replaces them with truth." },
      { t: "p", x: "As this love is received, it begins to form us." },
      { t: "p", x: "Love is not only something we enjoy in God's presence. It becomes something the Spirit shapes into our character. Paul says, 'The fruit of the Spirit is love...' (Galatians 5:22). Love is listed first because it gives shape to every other expression of fruit. Joy without love can become shallow. Peace without love can become self-protection. Patience without love can become mere tolerance. Kindness without love can become performance. Faithfulness without love can become duty without affection." },
      { t: "p", x: "Love is the atmosphere in which all true fruit matures." },
      { t: "p", x: "This also guards everything else we have received. Gifts without love can become performance. Knowledge without love can become pride. Fruitfulness without love can become self-display. Appointment without love can become ambition. Influence without love can become control. Love keeps the whole life aligned with God's heart." },
      { t: "d" },
      { t: "p", x: "This is why Jesus gives love as the mark of discipleship. 'By this all will know that you are My disciples, if you have love for one another.' The word translated 'know' carries the sense of recognizing and understanding through experience. Love makes discipleship visible. The world does not merely hear that we belong to Jesus. It recognizes Him through the love manifested in us." },
      { t: "p", x: "That love must become practical." },
      { t: "p", x: "Jesus says, 'A new commandment I give to you, that you love one another; as I have loved you...' (John 13:34). The pattern is clear: as He loved us, we love others. Freely received, freely given." },
      { t: "p", x: "Love becomes visible through obedience, service, sacrifice, forgiveness, compassion, generosity, patience, truth spoken with grace, and the willingness to lay down our lives for others. John says, 'Let us not love in word or in tongue, but in deed and in truth' (1 John 3:18). Love is not merely announced. It is demonstrated." },
      ...
      { t: "p", x: "'God is love' (1 John 4:8). Not merely God has love. God is love. To manifest His love is to reveal His nature." },
      { t: "d" },
      { t: "p", x: "This brings us back to the land of our assignment. We are not sent into our families, workplaces, cities, industries, ministries, communities, and nations merely to succeed. We are sent to reveal the Father's love." },
      ...
      { t: "p", x: "This is how God's love moves from doctrine to demonstration." },
      { t: "d" },
      { t: "p", x: "As we end this forty-day journey, we do so with gratitude. The call to dwell is not a finished lesson or a completed devotional plan. It is a lifelong invitation. We continue to dwell in Christ, abide in His Word, yield to His Spirit, bear fruit, steward gifts, walk in friendship, occupy faithfully, and manifest His love where He sends us." },
      { t: "p", x: "And we do this with hope. The God who began this good work in us will complete it. What He has started, He will perfect. The love we now receive in part, we will one day know in fullness. The dwelling life we practice now will continue into eternity, where God Himself will dwell with His people forever." },
      { t: "p", x: "So let this final day be both a culmination and a commission. Receive His love. Remain in His love. Be formed by His love. Express His love. Carry His love into the world." },
      { t: "p", x: "Because in the end, the clearest evidence that we have truly dwelt with God is that His love is made visible through us." },
      { t: "d" },
      { t: "p", x: "Father, thank You for loving me first and drawing me into life with You. Let Your love take deeper root in my heart, shape my character, and flow through my life. Teach me to love as Christ has loved me, in truth, humility, compassion, and sacrifice. Keep me dwelling in You beyond these forty days, bearing fruit for Your glory and manifesting Your love to the world. Amen." },
    ],
    journal: [
      "How has this journey helped you receive God's love more deeply?",
      "Where is God inviting you to manifest His love more intentionally?",
      "What barriers may be hindering the flow of love through you?",
      "What practices will help you continue dwelling in God's love beyond this journey?",
    ],
    prayers: [
      "Thank God for loving you first and revealing His love through Christ.",
      "Receive grace to remain rooted in God's love beyond this devotional journey.",
      "Ask the Holy Spirit to remove barriers that hinder love from flowing through you.",
      "Pray for grace to express love through obedience, service, forgiveness, and truth.",
      "Ask that your life will continually manifest God's love and bring glory to the Father.",
    ],
    declaration: "I am deeply loved by God, and His love is shaping my heart and life. As I abide in Christ and remain in His Word, His Spirit teaches me to love with truth, humility, compassion, and grace. I live from the security of being loved by the Father. God's love flows through me into every place He sends me. I choose to express His love through obedience, forgiveness, service, patience, and truth. My life will reveal the heart of Jesus and bring glory to the Father. Amen.",
  },
];
